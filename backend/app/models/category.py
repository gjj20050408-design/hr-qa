...
class Category(Base):
    ...
    type = Column(CaseInsensitiveEnum(CategoryType), nullable=False)
    access_level = Column(CaseInsensitiveEnum(AccessLevel), nullable=False, default=AccessLevel.ALL_ROLES)
