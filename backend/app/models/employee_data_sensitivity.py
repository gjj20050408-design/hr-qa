...
from app.models.base import CaseInsensitiveEnum
...
class EmployeeDataSensitivity(Base):
    ...
    sensitivity_level = Column(CaseInsensitiveEnum(SensitivityLevel), nullable=False, default=SensitivityLevel.PUBLIC)
